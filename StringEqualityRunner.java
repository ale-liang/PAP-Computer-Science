public class StringEqualityRunner
{
   public static void main(String[] args)
   {
      ...
      StringEquality test1 = new StringEquality("one","two");
      System.out.println(test1);
      
      StringEquality test2 = new StringEquality("three","four");
      System.out.println(test2);
      
      StringEquality test3 = new StringEquality("TCEA","UIL");
      System.out.println(test3);
      
      StringEquality test4 = new StringEquality("State","Champions");
